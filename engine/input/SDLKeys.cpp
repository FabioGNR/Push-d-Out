...
namespace input {
    const std::map<SDL_Keycode, Keys> SDLKeys::KEYCODES = {
        ...
        { SDLK_F11, Keys::F11 },
        { SDLK_F12, Keys::F12 },
        { conStart + SDL_CONTROLLER_BUTTON_A, Keys::CON_A },
        { conStart + SDL_CONTROLLER_BUTTON_B, Keys::CON_B },
        { conStart + SDL_CONTROLLER_BUTTON_X, Keys::CON_X },
        { conStart + SDL_CONTROLLER_BUTTON_Y, Keys::CON_Y },
        { conStart + SDL_CONTROLLER_BUTTON_DPAD_LEFT, Keys::CON_DPAD_LEFT },
        { conStart + SDL_CONTROLLER_BUTTON_DPAD_RIGHT, Keys::CON_DPAD_RIGHT },
        { conStart + SDL_CONTROLLER_BUTTON_DPAD_UP, Keys::CON_DPAD_UP },
        { conStart + SDL_CONTROLLER_BUTTON_DPAD_DOWN, Keys::CON_DPAD_DOWN },
        { conStart + SDL_CONTROLLER_BUTTON_LEFTSHOULDER, Keys::CON_LEFTSHOULDER },
        { conStart + SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, Keys::CON_RIGHTSHOULDER },
        { conStart + SDL_CONTROLLER_BUTTON_LEFTSTICK, Keys::CON_LEFTSTICK },
        { conStart + SDL_CONTROLLER_BUTTON_RIGHTSTICK, Keys::CON_RIGHTSTICK },
        { conStart + SDL_CONTROLLER_BUTTON_START, Keys::CON_START },
